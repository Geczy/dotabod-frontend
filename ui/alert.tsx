...
Alert.Trigger = React.forwardRef<HTMLButtonElement, AlertDialogPrimitives.AlertDialogTriggerProps>(
...
Alert.Content = React.forwardRef<HTMLDivElement, AlertDialogPrimitives.AlertDialogContentProps>(
...
Alert.Title = React.forwardRef<HTMLHeadingElement, AlertDialogPrimitives.AlertDialogTitleProps>(
...
Alert.Cancel = React.forwardRef<HTMLButtonElement, AlertDialogPrimitives.AlertDialogCancelProps>(
...
Alert.Action = React.forwardRef<HTMLButtonElement, AlertDialogPrimitives.AlertDialogActionProps>(
