...
exports.Prisma.Steam_to_twitchScalarFieldEnum = makeEnum({
  id: 'id',
...
exports.Prisma.Twitch_tokensScalarFieldEnum = makeEnum({
  id: 'id',
  created_at: 'created_at',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\matt\\Documents\\GitHub\\njs13\\twitch-frontend\\lib\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "lib\\prisma\\libquery_engine-rhel-openssl-1.0.x.so.node")
